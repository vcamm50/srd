...
# Representatives
- As mentioned, representatives don't gain XP as a normal character. Their XP will track the gold-as-XP treasure returned to [canyons-whisper](../Locations/canyons-whisper.md) by their still-breathing agent. 
...
# Agents
- Agents gain experience by their time on excursions (monster slaying or other awards) as well as treasure returned to [canyons-whisper](../Locations/canyons-whisper.md) as per the OSE rules.
