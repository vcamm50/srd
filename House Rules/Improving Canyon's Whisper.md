...
- Lvl 0 - nothing of note, maybe a shack with a cheap idol
- Lvl 1 - Two priests; can cast lvl 1 spells
- Lvl 2 - Two priests; can cast lvl 2 spells
- Lvl 3 - Lvl 1 and 2 clerical spell scrolls may be available in the Market
- Lvl 4 - Three priests; Priests can cast lvl 3 spells
- Lvl 5 - Lvl 3 clerical spell scrolls may be available in the Market
- Lvl 6 - Four priests can cast lvl 4 spells
- Lvl 7 - Lvl 4 clerical spell scrolls may be available in the Market
- Lvl 8 - Five priests can cast Lvl 5 spells
 
## Military Services
Armory, availability of mercenaries. _Levels as Fighter_
- Lvl 0 - non-existent and/or useless
- Lvl 1 - supports 1 armorer - no mercenaries
- Lvl 2 - supports 2 armorers/gunsmiths - light footmen available as mercenaries
- Lvl 3 - supports 3 armorers/gunsmiths - archers/crossbowmen available as mercenaries
- Lvl 4 - supports 4 armorers/gunsmiths, one of whom is now an Expert (can create mundane weapons/armor with +1 bonus at x30 cost) - musketeers/heavy footmen - non-human mercenaries available.
- Lvl 5 - supports 5 armorers/gunsmiths, two of whom are Experts, and the Experts can use exotic materials (see list below, Market Services must also be at Lvl 5). - light horsemen available
- Lvl 6 - supports 6 armorers/gunsmiths, two of who are Experts and one of whom is a Master (+2 total mundane bonus to weapons at x500 cost) - heavy horsemen available
- Lvl 7 - supports 7 armorers/gunsmiths - unique mercenaries available
 
## Market Services
Availability of items/gear/etc. _Levels as Thief_
- Lvl 0 - may be able to buy potatoes
- Lvl 1 - basic supplies and equipment
- Lvl 2 - May reroll failures once on availability.
- Lvl 3 - May reroll failures twice on availability. A jeweler is now available: Any type of gem 50 gp or less - 80% availability; Gems 50 to 500 gp or less - 30% availability; Gems 500 or more - 5% availability.
- Lvl 4 - May reroll failures thrice on availability. Expert tier equipment becomes available - this costs x50, has 1/2 availability of the item in question, and provides a +1 bonus to suitable rolls made with that item. Poisons per Carcass Crawler #5, pages 18-19, become available. Availability = chance of detection (except for Antithesis of Weal, that has a 2% availability).
- Lvl 5 - May reroll failures thrice on availability. Exotic materials become available for the creation of weapons and armor. Military Services must also be at lvl 5 to use.
- Lvl 6 - May reroll failures thrice on availability. Master tier equipment becomes available. This costs x30, has 1/4 availability of the item in question, and provides either a +2 bonus to suitable rolls or a +1 bonus to two different suitable rolls.
- Lvl 7 - Availability is no longer checked; all things are available.
 
## Magical Services
Access to magical capabilities. _Levels as Magic-user_

NOTE: the level of the Market must exceed the level of the magical item/scroll/etc being created for it to be available.
- Lvl 0 - Not a damn thing
- Lvl 1 - one occultist; can cast lvl 1 spells
- Lvl 2 - one occultist; can cast lvl 2 spells - also 1 of alchemist, sage, enchanter
- Lvl 3 - Lvl 1 and 2 magic-user/illusionist scrolls may be available in the Market.
- Lvl 4 - two occultists; can cast lvl 3 spells - also 2 of alchemist, sage, enchanters
- Lvl 5 - Lvl 3 magic-user/illusionist scrolls may be available in the Market
- Lvl 6 - two occultists; can cast lvl 4 spells - all of alchemist, sage, enchanter
- Lvl 7 - Lvl 4 magic-user/illusionist scrolls may be available in the Market
- Lvl 8 - three occultists, can cast lvl 5 spells - one extra of alchemist, sage, enchanter